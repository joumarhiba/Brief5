...
<main class="main">
	<aside class="sidebar">
	  <nav class="nav">
		<ul>
		  ...
		  <li><a href="./posts/viewPosts.php">Voir Publications</a></li>
  ...
  <section class="head">
	  <div class="background1">
		...
		<!-- <p> Show your LOVE of movies.</p> -->
	  </div>
	  <div class="background2"></div>
	  <a class="btn" href="/app/views/login.php">Créer Un Compte</a>
  </section>

  <section>
	  <!-- comédie / drama/aventure / fantastique / action / horreur -->
